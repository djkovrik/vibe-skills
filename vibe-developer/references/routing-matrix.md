...
| Decompose | “Add a stateless callback screen component.” | “Build the onboarding component tree and public models.” | “Implement a UI-visible component model.” -> MVIKotlin owns its required Store after the contract | “Add Store-backed tab navigation.” -> Decompose owns component/navigation; MVIKotlin owns Store |
| MVIKotlin | “Add a retained MVIKotlin Store for this component model.” | “Implement UI-visible state for SCREEN-004 through Manager/Result/unwrap.” | “Forward a button click to parent without a model.” -> Decompose | “Store currently performs pricing math.” -> Domain extracts calculation; MVIKotlin keeps orchestration |
...
| every UI-visible screen component model, async or synchronous | MVIKotlin |
