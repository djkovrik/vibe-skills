...
5. Freeze the ASSET inventory and acquisition briefs; route creation/generation to Assets Creator. Deliver real Compose Resources before recording affected UI goldens. Preserve unresolved exact external brand inputs as blockers.
...
12. Fix objective contract defects directly, routing artwork defects to Assets Creator. Get a user decision for material product/design changes, experimental API adoption or unavailable exact external brand inputs; approved original artwork is created during implementation.
