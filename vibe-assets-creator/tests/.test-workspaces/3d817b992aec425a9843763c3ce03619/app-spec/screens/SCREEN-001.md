...
ASSET-001 supplies the back action; ASSET-002 supplies the save action. Consume both as Compose Multiplatform Resources at the declared dp size, using the production resources in previews. No custom logo or illustration is required.
